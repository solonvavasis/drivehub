...
if(isset($_POST['Upload'])){
		...
		$s = $mysqli->query("UPDATE cars SET image = '".$_FILES['file']['name']."' WHERE car_id = '$id'");	
				
        }
		
     //bring car image from db
            ...
            <div class="row">
                ...
                <form method="POST" action="<?=$_SERVER['PHP_SELF']?>" enctype="multipart/form-data" name="ImageUploadForm" id="ImageUploadForm">
                    ...
                    <span class="btn btn-file pull-right">
                       <input type="submit" name="Upload" value="Upload" class="btn black">
                    </span>
                    <input type="submit" class="btn continue-btn" value="Update" name="editimage">
