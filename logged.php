			...
			<div class="wrap">
				...
				<nav role="navigation" class="main-nav">
					<ul class="nav navbar-nav navbar-right">
                        <li>
                        <a href="<?php 
							//dynamic links for profile and logout
							if ($user['user_lvl'] == "simple"){
								echo "simpleprofile.php?id={$_SESSION['user_id']}";
							}elseif ($user['user_lvl'] =="full")
							{
								echo "profile.php?id={$_SESSION['user_id']}";
							}
						?>">
                        <button type="button" class="btn large  wow fadeInLeft anchor login_btn">Profile</button></a>
                        </li>
                        <li>
                           <a href="<?php echo 'logout.php';?>">
                           <button type="button" class="btn large  wow fadeInLeft anchor login_btn">Log Out</button></a>
                        </li>
                  </ul>
                  </nav>      
			</div>
	...
	<main class="main" role="main">
		...
		<div class="intro img-responsive">
			<div class="wrap">
				<div class="textwidget">
					...
					<div class="actions">
						<a href="<?php echo "latest_logged.php?id=$id";?>" class="btn large black wow fadeInLeft anchor">Latest Cars</a>
						<a href="<?php echo "popular_logged.php?id=$id";?>" class="btn large black wow fadeInRight anchor">Popular Cars</a>
						<?php if($user['user_lvl']=="simple"){
							echo "<a href='addcar1.php?id=".$id."' class='btn large white wow fadeInRight anchor'>Add your Car</a>";
						}?>
					</div>
				</div>
			...
			<div class="wrap">
				<form role="form" action="" method="post">
					...
					<div class="f-row">
						<div class="form-group select one-third">
							...
							<select name="from">
                                ...
                                <optgroup label="Thessaloniki">
									...
									<option value="Valaoriti">Valaoriti</option>
								</optgroup>
                                <optgroup label="Kavala">
                        ...
                        <input type="submit" class="btn large white pull-right find_btn" value="Find Transfer" name="find"/>
					</div>
					<!-- //Row -->
		...
		<div class="services boxed white" id="services">
			...
			<article class="one-fourth wow fadeIn">
				...
				<div class="details">
					...
					<a class="more" title="Read more" href="services.php">Read more</a>
				</div>
			</article>
			<!-- //Item -->
		...
		<div class="color cta">
			<div class="wrap">
				...
				<a href="<?php echo "destinations.php?id=$id";?>" class="btn huge black right wow fadeInRight">CLICK HERE</a>
			</div>
		</div>
		<!-- //Call to action -->
	</main>
