...
<html lang="en">
    ...
    <head>
        ...
        <title>Add Car - Step One | Drivehub</title>
    </head>
        ...
        <div class="container">
            <div class="row">
                <div class="headline-addcar col-md-12">
                    <h2>Add Your Car</h2>
                    <p>Add your car in just <strong>3</strong> steps.</p>
                   ...
                   <div class="carcubic">
                    <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                        <div class="form-group col-md-12">
                            <label for="inputcubic" class="col-sm-2 control-label"><p>Cubic (cc)</p></label>
                            <div class="col-sm-5 col-md-4">
                                <input type="text" class="form-control" id="inputcubic" placeholder="cc" name="cc" required>
                            </div>
                        </div>
                        <div class="form-group col-md-12">
                            <label for="inputlength" class="col-sm-2 control-label"><p>Price/Day</p></label>
                            <div class="col-sm-5 col-md-4">
                                <input type="text" class="form-control" id="inputlength" placeholder="&euro;" name="price" required>
                            </div>
                        </div>    
                        <div class="form-group col-md-12">    
                            <label for="inputlength" class="col-sm-2 control-label"><p>Brand</p></label>
                            <div class="col-sm-5 col-md-4">
                                <input type="text" class="form-control" id="inputlength" placeholder="brand" name="brand" required>
                            </div>
                        </div>    
                        <div class="form-group col-md-12">    
                            <label for="inputlocation" class="col-sm-2 control-label"><p>Description</p></label>
                            <div class="col-sm-10 col-md-10">
                                <textarea rows="10" cols="10" placeholder="write description for your car" name="description"></textarea>
                            </div>
                        </div>    
                            
                            <div class="row">
                                <input type="submit" class="btn continue-btn" value="Continue to Step 2" name="submit_step_1">
                            </div> 
