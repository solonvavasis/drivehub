  ...
  <body>
   ...
   <?php
	...
	## connect mysql server
		...
		//select latest added cars from db
		$latest = "SELECT * from cars order by car_id desc limit 5";
		...
		<div class="wrap">
			<div class="row">
				...
				<div class="full-width content">
					<h2 style="margin-top:30px;">Latest added cars. <a href="login.php"/>Login</a> now to make a booking!</h2>
					
					<div class="results">
                    <?php $result = $mysqli->query($latest);
					      if ($result->num_rows > 0) {
						
						
				while($found = $result->fetch_array()){
					
				//echo latest added cars
				...
				echo "<article class='result'>
								...
								<div class='one-half heightfix'>
									<h3><img height='60' width='60' src='images/label_new red.png' alt='new'/>".$found["car_brand"]."<a href='javascript:void(0)' class='trigger color' title='Read more'>Description</a></h3>
									<ul>
										<li>
