				...
				<div class="content one-half modal">
					...
					<div class="box">
						<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
							...
							<div class="f-row">
								<div class="full-width">
									<input type="submit" name="submit" value="Login" class="btn color medium full" />
								</div>
							</div>
							
							<p><a href="forgot.php">Forgotten password?</a><br />Dont have an account yet? <a href="register.php">Sign up</a>.</p>
						</form>
...
if (isset($_POST['submit'])) {
	...
	if ($result->num_rows != 1) {
		...
		//match input password with db password
